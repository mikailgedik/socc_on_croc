...
const SV_TEMPLATE: &'static str = r#"// AUTOGENERATED FOR SOCC_ON_CROCC
//Mikail Gedik
//Thomas Herzog
module %MODULE_NAME% #(
)(
...
impl Machines {
    ...
    pub fn to_sv(&self, machine: usize, module_name: &str) -> String {
        ...
        let out_start_ff: usize = PREVIOUS_STAGE_FF[1..PREVIOUS_STAGE_FF.len() - 1]
            .iter()
            .fold(0, |a, b| a + b);
        ...
        return SV_TEMPLATE
            ...
            .replace("%WIDTH_IN%", &(PREVIOUS_STAGE_FF[0] - 1).to_string())
            .replace(
                "%WIDTH_OUT%",
                &(PREVIOUS_STAGE_FF[PREVIOUS_STAGE_FF.len() - 1] - 1).to_string(),
            )
