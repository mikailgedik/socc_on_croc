module address_generator #(
    ...
    input logic [COUNTER_WIDTH-1:0] screen_x_i,
    input logic [COUNTER_WIDTH-1:0] screen_y_i,
    // Since every character is two bytes, the index has a bit more
    // Because each address encodes four bytes
...
always_comb begin
    ...
    x_idx = (RAM_ADDR_WIDTH+1)'(screen_x_i / GLYPH_WIDTH_BITS);
    y_idx = (RAM_ADDR_WIDTH+1)'(screen_y_i / GLYPH_HEIGHT_BITS);
